...
**Depends on**: Fase 7.1 (P0.1-P0.4 código entregue; sectoral_pigments wire ativo no Modal payload) + **Fase 7.1.5** (detect/segment producing geometrically consistent polar unwrap — bloqueante). Pode rodar em paralelo com Fase 7 LLM (audit gates ANCHOR_RE + LGPD-aware já corretos via 07.1-01).
