...
**⚠️ ABERTO — DESEQUILÍBRIO DE ELEMENTOS (founder pegou 2026-07-22):** o de-para é carga/sombra-heavy → 🔥Fogo/💧Água/🌍Terra dominam as cargas; **💨Ar quase não aparece → Sanguíneo quase nunca dominante**. Ar/Sanguíneo é temperamento de POLO POSITIVO (alegria/social/leveza) → mora nos **RECURSOS + na CONSTITUIÇÃO/ESTRUTURA** (fibras abertas ≈ Flor/Corrente Rayid), NÃO nas cargas. FIX proposto (founder decide): Ar vem de recursos+estrutura (não esperar das cargas) + possível **normalização por cobertura** (não penalizar elemento com menos "slots"). Os 4 elementos NÃO são simétricos na íris.
