...
- Termina com **UMA pergunta maiêutica** (parágrafo separado, 1 frase curta, `?`). **MÉTODO (herdado do §0 do Stage 2 de PRODUÇÃO — 3 famílias mutuamente exclusivas; escolha a que EMERGE desta pessoa, dos achados/emoções da tabela):** (1) **Espelho** — pega o ÚLTIMO elemento da história/microfilme e devolve como interrogação; (2) **Testemunho** — aponta uma ausência viva (quem nunca te perguntou como você está, quem você segurou calado); (3) **Virada simples** — traz pro presente, sem ornamento. Ancora na emoção do MAIOR achado. **⭐ PREFIRA A GENERATIVA — a que faz a pessoa PRODUZIR a própria resposta** (maiêutica clássica: a pessoa pare o insight), NÃO sim/não fechado. Ex. de FORMA (não copie): "quem você precisava ser pra não incomodar?", "o que, dentro de você, ainda espera a hora de ser dito?". A âncora somática (o corpo) é ÓTIMA — mas o lugar dela é o BLOCO 6 (perguntas pra sessão); aqui a abertura é generativa/reflexiva. Critérios: emerge DESTA pessoa · abre auto-descoberta · NUNCA coach-instagram ("será que você já se permitiu…?").
...
**As Chaves (perguntas do subconsciente), pareadas por marco ativo:** "Abre o estado" + "Resolução". Regras: (1) **GENERATIVAS** — fazem a pessoa PRODUZIR a própria resposta sobre um PADRÃO/papel que ela reconhece ("Quem você precisava ser pra ser aceito?"), não recordação de um FATO dateável ("quando foi a última vez que…" = pode morrer no "não lembro"); (2) ancoram na NATUREZA do marco, não genéricas de fase; (3) somático NÃO aqui (é do bloco 6) — aqui é reflexão que abre auto-descoberta.
