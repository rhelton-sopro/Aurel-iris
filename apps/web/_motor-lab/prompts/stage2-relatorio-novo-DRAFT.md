...
- Termina com **UMA pergunta maiêutica** (parágrafo separado, 1 frase curta, `?`). **MÉTODO (herdado do §0 do Stage 2 de PRODUÇÃO — 3 famílias mutuamente exclusivas; escolha a que EMERGE desta pessoa, dos achados/emoções da tabela):** (1) **Espelho** — pega o ÚLTIMO elemento da história/microfilme e devolve como interrogação; (2) **Testemunho** — aponta uma ausência viva (quem nunca te perguntou como você está, quem você segurou calado); (3) **Virada simples** — traz pro presente, sem ornamento. Ancora na emoção do MAIOR achado. **Prefira o corpo/presente** (a "Virada" com âncora somática): ex. de FORMA — "…e ainda hoje você sente esse nó subir quando engole o que ia dizer?" — o método somático já operando na 1ª página. Critérios (produção): emerge DESTA pessoa · não pressupõe nada não estabelecido · NUNCA cognitiva/passado ("quando foi a última vez…?") nem coach-instagram ("será que você já se permitiu…?").
