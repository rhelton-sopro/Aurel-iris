...
- boa: íris claramente maior que 1/8 da menor dimensão (passa no teste 'muito_longe' invertido — qualquer rosto enquadrado normalmente passa nisso) E pelo menos 30 fibras radiais individualmente contáveis (passa no teste 'borrado' invertido). Reflexo leve disperso é OK. Resto da imagem PODE estar fora de foco.
...
ESCOPO DE NITIDEZ (reforço da Regra 1): avalie nitidez SOMENTE na região circular colorida da íris. Ignore blur em pele, cílios, sobrancelha, e na esclera (branco do olho) — close-ups de smartphone têm profundidade de campo rasa que naturalmente deixa essas regiões fora de foco. MAS a íris EM SI deve passar no teste das 30 fibras radiais contáveis. Se a íris está suave/manchada/fundida/com-fibras-quase-mas-não-totalmente-nítidas, é 'borrado' INDEPENDENTE do resto da imagem estar nítido E INDEPENDENTE de haver "reflexo" presente (releia: mancha sem brilho específico = BLUR, não reflexo).

TIEBREAKERS (ordem importa):
- Em dúvida APENAS entre excelente/boa/regular (com nitidez DA ÍRIS já confirmada como ≥30 fibras): prefira 'boa'. Não rebaixe para 'regular' por reflexo pequeno.
- Em dúvida entre 'borrado' e 'boa' por contagem de fibras (~28-32 visíveis ou fibras quase-nítidas): prefira 'borrado'. Falso negativo destrói análise downstream.
